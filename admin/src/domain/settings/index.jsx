...
import EthIcon from "../../components/fundamentals/icons/eth-icon"
...
import CryptoManage from "./crypto-manage"
  ...
  return (
    <SettingsOverview>
      ...
      <SettingsCard
        ...
        description={"Manage crypto payment"}
        icon={<EthIcon />}
        to={`/a/settings/crypto-manage`}
      />
...
const Settings = () => (
  <Routes className="h-full">
    ...
    <Route path="/crypto-manage/*" element={<CryptoManage />} />
  </Routes>
)
